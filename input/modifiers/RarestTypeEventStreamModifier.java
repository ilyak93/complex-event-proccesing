...
public class RarestTypeEventStreamModifier implements IEventStreamModifier {
	...
	public RarestTypeEventStreamModifier(int rarestEventTypeFilteringFactor, int rarestEventTypeDuplicatingFactor) {
		eventCounter = 0;
		...
		if (this.rarestEventTypeFilteringFactor > 1 && this.rarestEventTypeDuplicatingFactor > 1)
			throw new RuntimeException("Inconsistent Filtering & Duplicating parameters provided");
